...
namespace SkeletonGame
{
    public class Game1 : Game
    {
        ...
        protected override void Initialize()
        {
            ...
            this.engine = new Engine(this.repository, this._spriteBatch, this.GraphicsDevice); // Main class controlling all of the subclasses
            this.testEnemies = new TestEnemies(this.repository, this._spriteBatch, this.engine, this.GraphicsDevice);
        }
